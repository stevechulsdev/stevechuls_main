...
public class GridActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccountTextView = (TextView)headerView.findViewById(R.id.account_text);
        mAccountImageView = (ImageView)headerView.findViewById(R.id.account_image);

        mLoginBtn = (Button)headerView.findViewById(R.id.google_login_btn);
        ...
        mLogoutBtn = (Button)headerView.findViewById(R.id.google_logout_btn);
        mLogoutBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mFirebaseAuth.signOut();
                mGoogleSignInClient.signOut().addOnCompleteListener(GridActivity.this, new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {

                        Toast.makeText(GridActivity.this, "로그아웃 되었습니다.", Toast.LENGTH_SHORT).show();
        ...
        mFirebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            Toast.makeText(GridActivity.this, "로그인 되었습니다.", Toast.LENGTH_SHORT).show();
                        ...
                        else
                        {
                            ...
                            Toast.makeText(GridActivity.this, "Authentication failed. ", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
