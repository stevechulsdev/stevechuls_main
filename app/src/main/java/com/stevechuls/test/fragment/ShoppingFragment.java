...
public class ShoppingFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FragmentViewPagerAdapter fragmentViewPagerAdapter = new FragmentViewPagerAdapter(getContext(), getChildFragmentManager());

        mTopViewPager = rootView.findViewById(R.id.main_top_viewpager);
        mTopViewPager.setAdapter(fragmentViewPagerAdapter);
