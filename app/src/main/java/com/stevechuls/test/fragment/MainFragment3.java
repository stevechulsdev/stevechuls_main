...
import com.stevechuls.test.fragment.recyclerview.RecyclerGridAdapter3;
import com.stevechuls.test.fragment.recyclerview.RecyclerGridItem;
...
public class MainFragment3 extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private RecyclerGridAdapter3 recyclerGridAdapter3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        httpRequest.callCarImageAPI(new ResponseListener() {
            ...
            public void onSuccess(JsonItem[] jsonItem) {
                ...
                // 서버로 부터 받은 데이터 가공
                ArrayList<RecyclerGridItem> arrayList = setListData(jsonItem);

                recyclerGridAdapter3 = new RecyclerGridAdapter3(getContext(), arrayList);

                // RecyclerGridView 세팅
                recyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));
                recyclerView.setAdapter(recyclerGridAdapter3);
    ...
    public void onRefresh() {
        ...
        if(recyclerGridAdapter3 != null)
        {
            // [stevechulsdev] 데이터 갱신 180413
            recyclerGridAdapter3.notifyDataSetChanged();
        }
     ...
     */
    private ArrayList<RecyclerGridItem> setListData(JsonItem[] jsonItem)
    {
        ArrayList<RecyclerGridItem> recyclerItemArrayList = new ArrayList<>();
        for(int i=1; i<=jsonItem.length; i++)
        {
            RecyclerGridItem recyclerItem = new RecyclerGridItem();
