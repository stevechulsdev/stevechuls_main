...
public class FragmentViewPagerBottomAdapter extends FragmentPagerAdapter {
    ...
    public FragmentViewPagerBottomAdapter(Context context, FragmentManager fm) {
        super(fm);
...
//        }
        ...
        Log.e("ksc", "FragmentViewPagerBottomAdapter position : " + position);
