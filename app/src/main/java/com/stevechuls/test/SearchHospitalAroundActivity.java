...
public class SearchHospitalAroundActivity extends NMapActivity {

    private String LOG_TAG = "[stevechulsdev] SearchHospitalAroundActivity";
    ...
    private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
        ...
        public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
            ...
            { // fail
                if(DEBUG) { Log.e(LOG_TAG, "onFailedToInitializeWithError: " + errorInfo.toString()); }

                Toast.makeText(SearchHospitalAroundActivity.this, errorInfo.toString(), Toast.LENGTH_LONG).show();
            }
        }
        ...
        public View onCreateCalloutOverlayView(NMapOverlay itemOverlay, NMapOverlayItem overlayItem, Rect itemBounds) {
            ...
            if (overlayItem != null) {
                ...
                if (title != null && title.length() > 5) {
                    return new NMapCalloutCustomOverlayView(SearchHospitalAroundActivity.this, itemOverlay, overlayItem, itemBounds);
                }
            }
            ...
            if (itemOverlay instanceof NMapPOIdataOverlay) {
                ...
                if (!poiDataOverlay.isFocusedBySelectItem()) {
                    ...
                    if (countOfOverlappedItems > 1) {
                        ...
                        Toast.makeText(SearchHospitalAroundActivity.this, text, Toast.LENGTH_LONG).show();
                        return null;
                    }
                }
            }
    ...
    private final OnDataProviderListener onDataProviderListener = new OnDataProviderListener() {
        ...
        public void onReverseGeocoderResponse(NMapPlacemark placeMark, NMapError errInfo) {
            ...
            if (errInfo != null)
            {
                if(DEBUG) { Log.e(LOG_TAG, "Failed to findPlacemarkAtLocation: error=" + errInfo.toString()); }

                Toast.makeText(SearchHospitalAroundActivity.this, errInfo.toString(), Toast.LENGTH_LONG).show();
                return;
            }
