...
import com.stevechuls.test.mainviewfragment.adapter.MainViewFragmentAdapter;
...
public class MainViewActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private MainViewFragmentAdapter mainViewFragmentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainViewFragmentAdapter = new MainViewFragmentAdapter(manager);

        // 뷰페이저 세팅
        mViewPager = findViewById(R.id.container);
        mViewPager.setAdapter(mainViewFragmentAdapter);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Toast.makeText(MainViewActivity.this, "준비중...", Toast.LENGTH_SHORT).show();
            return true;
        }
